...
print(f'Accuracy on test set no max depth: {accuracytest0:.2f}')
...
def depthsearch(Xtrain, ytrain, Xval, yval):
    best_depth = None
    best_accuracy = 0
    for depth in range(1, 50):  # Trying depths from 1 to 20
...
print(f'Accuracy on test set with optimal depth: {accuracy:.4f}')
print('Classification Report:')
